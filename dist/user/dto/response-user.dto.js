...
const response_role_dto_1 = require("../../role/dto/response-role.dto");
...
], ResponseUserDto.prototype, "isActive", void 0);
__decorate([
    (0, class_transformer_1.Expose)(),
    (0, class_transformer_1.Transform)(({ obj }) => obj.role?.name),
    __metadata("design:type", response_role_dto_1.ResponseRoleDto)
...
], ResponseUserDto.prototype, "roleId", void 0);
__decorate([
    (0, class_transformer_1.Exclude)(),
    __metadata("design:type", String)
